    ...
    fn test_get_invitation() -> Result<()> {
        ...
        with_mockito(
            ...
            |client| {
                ...
                assert_eq!(invitation.id, 12345);
                assert_eq!(invitation.email, "user@example.com");
                assert_eq!(invitation.invitation_id, "inv_abc123");
                assert_eq!(
                ...
                assert_eq!(invitation.workspace_id, 111111);
                assert_eq!(invitation.workspace_name, "My Workspace");
                assert_eq!(invitation.organization_id, Some(222222));
                assert_eq!(
