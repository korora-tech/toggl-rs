...
impl DataTrendsClient {
    ...
    pub fn clients(
        ...
        let path = format!("/workspace/{}/data_trends/clients", workspace_id);
    ...
    pub fn projects(
        ...
        let path = format!("/workspace/{}/data_trends/projects", workspace_id);
        self.client.request_with_body(Method::POST, &path, request)
    }
    ...
    pub fn users(
        ...
        let path = format!("/workspace/{}/data_trends/users", workspace_id);
        self.client.request_with_body(Method::POST, &path, request)
    }
}
