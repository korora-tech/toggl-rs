...
use crate::model::api::invitation::*;
use crate::model::api::organization::*;
use crate::model::api::organization_subscription::*;
use crate::model::api::segmentation::*;
use reqwest::Method;
...
impl OrganizationsClient {
    ...
    pub fn create_workspace(
        &self,
        organization_id: u64,
        workspace: &crate::model::api::workspace::CreateWorkspace,
    ) -> Result<crate::model::api::workspace::Workspace> {
        self.client.request_with_body(
            Method::POST,
            &format!("organizations/{}/workspaces", organization_id),
            workspace,
